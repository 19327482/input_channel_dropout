...
class FasterRCNNResnetV1FeatureExtractor(
  ...
  def __init__(self,
    ...
    """
    print("FasterRCNNResnet50FeatureExtractor line 62 is training")
    print(is_training)
  ...
  def preprocess(self, resized_inputs):
    ...
    if resized_inputs.shape.as_list()[3] == 3:
      print("ONLY 3 channels")
      channel_means = [123.68, 116.779, 103.939]
      return resized_inputs - [[channel_means]]
    else:
      color_channel_means = [123.68, 116.779, 103.939]
      number_of_additional_channels = resized_inputs.shape.as_list()[3] - 3
      print("CHANGED PREPROCESSING FOR " + str(number_of_additional_channels) + " DIMENSIONAL INPUT")
      additional_channels_means = [125. for _ in range(number_of_additional_channels)]
      channel_means = color_channel_means + additional_channels_means
      return resized_inputs - [[channel_means]]
  ...
  def _extract_proposal_features(self, preprocessed_inputs, scope):
    ...
    with tf.control_dependencies([shape_assert]):
      ...
      print("faster rcnn resnet v& feature extractor line 135 is training _train_batch_norm")
      print(self._is_training)
      print(self._train_batch_norm)
      with slim.arg_scope(
        ...
        with tf.variable_scope(
          ...
          _, activations = self._resnet_model(
              ...
              is_training_dropout=self._is_training,
              global_pool=False,
...
class FasterRCNNResnet50FeatureExtractor(FasterRCNNResnetV1FeatureExtractor):
  ...
  def __init__(self,
    ...
    """
    print("FasterRCNNResnet50FeatureExtractor line 208 is training")
    print(is_training)
